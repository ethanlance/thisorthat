...
import { validatePollForm, validateField, PollFormData } from '@/lib/validation/poll-validation';
...
describe('poll-validation', () => {
  ...
  describe('validatePollForm', () => {
    ...
    it('should validate option A label length', () => {
      ...
      expect(result.valid).toBe(false);
      expect(result.errors.optionALabel).toBe('Option A label must be 50 characters or less');
    });
    ...
    it('should validate option B label length', () => {
      ...
      expect(result.valid).toBe(false);
      expect(result.errors.optionBLabel).toBe('Option B label must be 50 characters or less');
    });
  ...
  describe('validateField', () => {
    it('should validate optionAImage field', () => {
      expect(validateField('optionAImage', null)).toBe('Option A image is required');
      expect(validateField('optionAImage', createMockFile())).toBe(null);
    });

    it('should validate optionBImage field', () => {
      expect(validateField('optionBImage', null)).toBe('Option B image is required');
    ...
    it('should validate optionALabel field', () => {
      ...
      expect(validateField('optionALabel', 'A'.repeat(51))).toBe('Option A label must be 50 characters or less');
    });
    ...
    it('should validate optionBLabel field', () => {
      ...
      expect(validateField('optionBLabel', 'B'.repeat(51))).toBe('Option B label must be 50 characters or less');
    });
    ...
    it('should validate description field', () => {
      ...
      expect(validateField('description', 'D'.repeat(501))).toBe('Description must be 500 characters or less');
    });
