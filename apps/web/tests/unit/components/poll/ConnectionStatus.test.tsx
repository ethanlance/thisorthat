...
describe('ConnectionStatus', () => {
  it('should not render when connected', () => {
    render(<ConnectionStatus isConnected={true} lastUpdate={new Date()} />);
  ...
  it('should show last update time when provided', () => {
    ...
    render(<ConnectionStatus isConnected={false} lastUpdate={lastUpdate} />);
  ...
  it('should apply custom className', () => {
    ...
    const container = screen
      .getByText('Connection lost. Attempting to reconnect...')
      .closest('div');
