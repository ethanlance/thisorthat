...
describe('AnimatedProgressBar', () => {
  it('should render with correct percentage', () => {
    render(<AnimatedProgressBar value={30} max={100} color="bg-blue-500" />);
  ...
  it('should calculate correct percentage', () => {
    render(<AnimatedProgressBar value={25} max={100} color="bg-blue-500" />);
  ...
  it('should handle zero max value', () => {
    render(<AnimatedProgressBar value={10} max={0} color="bg-blue-500" />);
  ...
  it('should apply color class to progress fill', () => {
    render(<AnimatedProgressBar value={50} max={100} color="bg-red-500" />);
  ...
  it('should handle edge case values', () => {
    render(<AnimatedProgressBar value={0} max={100} color="bg-blue-500" />);
