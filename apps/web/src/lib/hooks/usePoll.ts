    ...
    try {
      ...
      if (result.success) {
        ...
        setPoll(prevPoll => {
          ...
          const newVoteCounts = {
            option_a: choice === 'option_a' ? prevPoll.vote_counts.option_a + 1 : prevPoll.vote_counts.option_a,
            option_b: choice === 'option_b' ? prevPoll.vote_counts.option_b + 1 : prevPoll.vote_counts.option_b
          };
    ...
    const subscription = supabase
      ...
      .on('postgres_changes', {
        ...
        setPoll(prevPoll => {
          ...
          const newVoteCounts = {
            option_a: newVote.choice === 'option_a' 
              ? prevPoll.vote_counts.option_a + 1 
              : prevPoll.vote_counts.option_a,
            option_b: newVote.choice === 'option_b' 
